 ...
 * @Auther:zwl
 * @Version: 1.0
 * @create: 2019/12/6 22:32
 */
@WebServlet(name = "FindNewDynamicMsgServlet", urlPatterns = "/FindNewDynamicMsgServlet")
public class FindNewDynamicMsgServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            dynamicBeanList = service.findNewDynamicMsg(0,6);
