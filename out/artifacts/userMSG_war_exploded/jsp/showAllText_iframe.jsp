...
<div id="read_all_text_box">
    <div id="now_location">
        <h3>${requestScope.dynamicBean.title}</h3>
        <div id="div_right">
    ...
    <div id="text">
        ...
        <div id="comment_box">
            ...
            <c:forEach items="${requestScope.comList}" var="msgBean" varStatus="vs">
                <div class=\"comment\" id="comment_${vs.count}">
                    <dl>
                        <dt>
                            ...
                            <span class="readText"><a
                                    href="#" onclick="delete_comment('comment_${vs.count}','${msgBean.id}');return false;"
                                    title="删除评论">删除评论</a></span>
                        </dt>
...
<script type="text/javascript">
    ...
    //删除评论
    function delete_comment(div_id,id) {
        let xml_request = new XMLHttpRequest();
        xml_request.open('post', "${pageContext.request.contextPath}/DeleteCommentServlet", true);
    ...
    <%-- 隐藏表单--%>
    <%--<form id="_request" action="${pageContext.request.contextPath}/ShowCommentMsgServlet" method="post" target="iframe_box">--%>
    ...
    <%--    <input type="hidden" name="who" value="comment"/>--%>
    <%--    </form>--%>
    //发送请求
    function _request() {
