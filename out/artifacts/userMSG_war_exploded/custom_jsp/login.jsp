...
<div>
    <form action="${pageContext.request.contextPath}/FansUserLoginServlet" method="post">
        <div class="box">
            ...
            <div align="center">
                ...
                <c:if test="${not empty param.login_msg}">
                    <!-- 出错显示的信息框 -->
                    <strong style="color: #c7254e;">${param.login_msg}</strong>
                </c:if>
            </div>
            <div>
                <a href="${pageContext.request.contextPath}/jsp/forgotPassword.jsp"
                   style="float: left;margin-top: 10px;color: #c7254e;">忘记密码?</a>
                <a href="${pageContext.request.contextPath}/custom_jsp/register.jsp"
