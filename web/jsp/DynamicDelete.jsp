...
<div id="text_box">
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <p class="dd_text_2">
                            ...
                            <span class="readText"><a
                                    href="#" onclick="delete_dynamic();return false;"
                                    title="删除动态">删除动态</a></span>
                        <form id="delete_dynamic_form" action="${pageContext.request.contextPath}/DeleteDynamicServlet" target="iframe_box" method="post">
                            <input type="hidden" name="dy_id" value="${pageBean.id}"/>
                        </form>
                        </p>
                    </dd>
                </dl>
    ...
    <div id="click_more">
        <a href="${pageContext.request.contextPath}/ShowDynamicMsgServlet?currentPage=${requestScope.dynamicPage.currentPage - 1 > 0 ? requestScope.dynamicPage.currentPage - 1 : 1}&rows=${requestScope.dynamicPage.rows}&dynamic=0&who=God">&laquo;&laquo;</a>
        <a href="${pageContext.request.contextPath}/ShowDynamicMsgServlet?currentPage=${requestScope.dynamicPage.currentPage + 1 <= requestScope.dynamicPage.totalPage ? requestScope.dynamicPage.currentPage + 1 : requestScope.dynamicPage.totalPage}&rows=${requestScope.dynamicPage.rows}&dynamic=0&who=God"
           id="click_loading">点击加载更多</a>
        <a href="${pageContext.request.contextPath}/ShowDynamicMsgServlet?currentPage=${requestScope.dynamicPage.currentPage + 1 <= requestScope.dynamicPage.totalPage ? requestScope.dynamicPage.currentPage + 1 : requestScope.dynamicPage.totalPage}&rows=${requestScope.dynamicPage.rows}&dynamic=0&who=God">&raquo;&raquo;</a>
    </div>
</div>
</body>
<script>
    ...
    function delete_dynamic() {
        if(confirm("确定要删除吗？")){
            let form = document.getElementById("delete_dynamic_form");
            form.submit();
        }
    }
